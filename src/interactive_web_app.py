...
try:
    ...
    print("⚠️  Warning: Model not found. Please run model_trainer.py first.")
        ...
        function displayResults(data) {
            ...
            document.getElementById('results').innerHTML = `
                <div class="solar-prediction">
                    ...
                    <div class="solar-value">${prediction.solar_radiation} W/m²</div>
                ...
                <div class="result-card">
                    ...
                    <div class="coordinates">
                        ...
                        Latitude: ${weather.latitude.toFixed(4)}°<br>
                        Longitude: ${weather.longitude.toFixed(4)}°
                    </div>
                </div>
...
if __name__ == '__main__':
    ...
    print("=" * 50)
    print(f"🤖 Model Status: {'✅ Loaded' if model_loaded else '⚠️  Demo Mode'}")
    print(f"🌍 API Status: {'✅ Configured' if config.WEATHER_API_KEY != 'PUT_YOUR_API_KEY_HERE' else '⚠️  Demo Mode'}")
